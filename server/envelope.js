...
export const totalBudget = 2000;
export let envelopes = [];

let envelopeId = 1;

export let isValidEnvelopeId = (envelopeId) => {
    const foundEnvelope = envelopes.find((envelope) => envelope.id === envelopeId);
...
export const getEnvelopeById = (envelopeId) => { // try... catch should probably be used here
    try {
...
export const updateEnvelope = (envelopeId, newName, newBudget, newCurrentAmount) => { // hm, why not just (envelopeId, envelope)
